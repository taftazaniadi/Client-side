...
<body>
    <div style="float: left;margin-right: 10px;">
        <img src="cid:amcc" alt="Logo" style="height: 50px">
    </div>

    <h2 style="margin-bottom: 0;">Departemen Kerumahtanggaan || AMCC</h2>
    https://krt.amcc.or.id/
    ...
    <div style="text-align: justify">
        ...
        <!-- <?php echo $content; // Tampilkan isi pesan 
                ?> -->
    </div>
</body>
