...
class Sekre extends CI_Controller {
    ...
    public function add() {
        ...
        $this->load->view('admin/nav','refresh');
        $this->load->view('admin/sidebar','refresh');
        $this->load->view('admin/sekre/add',$this->data,'refresh');
        $this->load->view('admin/footer','refresh');
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('admin/nav','refresh');
        $this->load->view('admin/sidebar','refresh');
        $this->load->view('admin/sekre/edit',$data,'refresh');
        $this->load->view('admin/footer','refresh');
    }
